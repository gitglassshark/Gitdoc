...
int inital (int icp, int ic, int il)
{
...
bool pickupbig (int i[h][v], int ipicknum)
{
    ...
    cout << "The  than "<<ipicknum<<" more big numbers number is :\t" << ibig << endl;
    cout << "The  than "<<ipicknum<<" more small numbers number is :\t" << ismall << endl;
    cout << "The  than "<<ipicknum<<" more equal numbers number is :\t" << iequal << endl;
